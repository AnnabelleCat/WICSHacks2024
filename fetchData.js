...
fetch("https://api.openweathermap.org/data/2.5/weather?lat=30.29&lon=-97.75&appid=30e95db82ed7dd8753cce0bc9d88ddc3&units=imperial")
    ...
    .then((jsonData) => {
        ...
        document.getElementById("text_weatherDescription").innerText=jsonData.weather[0].description

        chrome.tabs.query({ active: true, currentWindow: true }, (tabs) => {
            chrome.tabs.sendMessage(tabs[0].id, { type: "change-image" });
          });
